...
class OrderWidget extends StatelessWidget {
  String shopName;
  OrderWidget({required this.shopName});

  @override
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider<OrderWidget>(
          create: (_) => OrderWidget(
            shopName: "",
          ),
        ),
      ],
...
class OrderListWidget extends StatefulWidget {
  ...
  OrderListWidget({required this.shopName});
  ...
  Widget build(BuildContext context) {
    return Provider<OrderBloc?>.value(
      ...
      child: Consumer<OrderBloc>(builder: (context, bloc, child) {
        bloc.getOrderList(widget.shopName).listen((event) {
        ...
        return StreamProvider<List<OrderData>?>.value(
          ...
          value: bloc.getOrderList(widget.shopName),
